        ...
        <div className="container max-w-3xl py-12">
          <div className="space-y-6">
            <div className="space-y-2 text-center">
              <h1 className="text-3xl font-bold">Aurora Labs Pet Device Survey</h1>
            ...
            <div className="rounded-lg border bg-card p-6 shadow-sm">
              <div className="space-y-4 mb-8">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <p className="mb-4">
                    At Aurora Labs, we are dedicated to enhancing the lives of pets and their owners through innovative
                  ...
                  <h2 className="text-lg font-semibold text-foreground mb-2">About Aurora Labs:</h2>
                  <p>
